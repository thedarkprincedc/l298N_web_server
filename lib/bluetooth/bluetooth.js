...
function bluetooth(io, pollInterval){
  ...
  this.blue.Bluetooth();
  this.hasBluetooth = this.blue.checkBluetoothController();
  this.blue.on(this.blue.bluetoothEvents.Device, bluetooth.prototype.onDeviceEvent );
  this.blue.on(this.blue.bluetoothEvents.Controller, bluetooth.prototype.onControllerEvent );
  this.blue.on(this.blue.bluetoothEvents.DeviceSignalLevel, bluetooth.prototype.onDeviceSignalLevelEvent);
}
