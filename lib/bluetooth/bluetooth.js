...
// }
function bluetooth(io, blue, pollInterval){
  this.io = io;
  this.pollInterval = pollInterval || 20000;
  this.blue = blue;
  this.blue.Bluetooth();
  this.hasBluetooth = this.blue.checkBluetoothController();
  // this.blue.on(this.blue.bluetoothEvents.Device, this.onDeviceEvent );
  // this.blue.on(this.blue.bluetoothEvents.Controller, this.onControllerEvent );
  // this.blue.on(this.blue.bluetoothEvents.DeviceSignalLevel,  this.onDeviceSignalLevelEvent);
}
