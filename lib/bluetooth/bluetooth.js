...
function bluetooth(io, pollInterval){
  ...
  this.blue.Bluetooth();
  this.hasBluetooth = this.blue.checkBluetoothController();
  this.blue.on(this.blue.bluetoothEvents.Device, (device) => bluetooth.prototype.onDeviceEvent(device) );
  this.blue.on(this.blue.bluetoothEvents.Controller, (controllers) => bluetooth.prototype.onControllerEvent(controllers));
  this.blue.on(this.blue.bluetoothEvents.DeviceSignalLevel, (devices, mac, signal) => bluetooth.prototype.onDeviceSignalLevelEvent(devices, mac, signal));
}
