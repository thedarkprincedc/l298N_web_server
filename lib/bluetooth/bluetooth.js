...
function bluetooth(io, pollInterval){
  ...
  this.blue.Bluetooth();
  this.hasBluetooth = this.blue.checkBluetoothController();
  this.blue.on(this.blue.bluetoothEvents.Device, (device) => this.onDeviceEvent(device) );
  this.blue.on(this.blue.bluetoothEvents.Controller, (controllers) => this.onControllerEvent(controllers));
  this.blue.on(this.blue.bluetoothEvents.DeviceSignalLevel, (devices, mac, signal) => this.onDeviceSignalLevelEvent(devices, mac, signal));
}
